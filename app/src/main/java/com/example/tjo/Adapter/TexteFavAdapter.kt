...
class TexteFavAdapter(var msg: List<TexteFav>):RecyclerView.Adapter<TexteFavAdapter.ViewHolder>()  {



    val simpleDate = SimpleDateFormat("dd/M/yyyy")

    var racinesFilterList = ArrayList<TexteFav>()


    private  var dataSet= arrayListOf<TexteFav>()
    ...
    class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        var date_pub: TextView = itemView.findViewById(R.id.tvFavDatePub)
        var date_sign: TextView = itemView.findViewById(R.id.tvFavDateSign)
        var text: TextView = itemView.findViewById(R.id.tvFavText)
        var type: TextView = itemView.findViewById(R.id.tvFavType)
        var annee: TextView = itemView.findViewById(R.id.tvFavTypeYear)
        var organe: TextView = itemView.findViewById(R.id.tvFavOrgane)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var viewObj = LayoutInflater.from(parent.context).inflate(R.layout.texte_fav_item, parent, false)
